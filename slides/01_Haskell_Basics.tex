...
\begin{frame}{Organisatorisches}
        \begin{itemize}
                ...
                \end{itemize}
                \item Ilias Forum für allgemeine Fragen
...
\begin{frame}{Übungsbetrieb}
        \begin{itemize}
                ...
                \item Abgabe:
                \begin{itemize}
                  \item Abgabe immer Donnerstag 12:00 Uhr
...
\begin{frame}{Klausur}
        \begin{itemize}
                \item 120 Minuten
                \item Termin: teile ich mit sobald bekannt, meist spät
                \item Papier-Materialien dürfen mitgebracht werden!
                \item $\leadsto$ Skript, Mitschriebe, \enquote{Formelsammlung}, Musterlösungen
        \end{itemize}
\end{frame}
...
\begin{frame}{Listen}
        \begin{itemize}
                ...
                \item Haben genau einen von zwei Werten:
                \begin{itemize}
...
\begin{frame}{Funktionen für Listen}
    \begin{itemize}
        \item \texttt{(++)}: Konkatenation von Listen
        \item \texttt{(!!)}: Indexzugriff, 1. Argument: Liste, 2. Argument: Index
        \item \texttt{head, last}: Erstes bzw. letztes Element
        \item \texttt{take, drop}: Die ersten \textit{n} Elemente bzw. die Liste ohne die ersten \textit{n} Elemente, 1. Argument: \textit{n}, 2. Argument: die Liste
        \item \texttt{length}: Länge der Liste
        \item \texttt{reverse}: Dreht die Liste
        \item \texttt{elem}: Testet ob \textit{x} in der Liste enthalten, 1. Argument: \textit{x}, 2. Argument: Liste
    \end{itemize}
\end{frame}
